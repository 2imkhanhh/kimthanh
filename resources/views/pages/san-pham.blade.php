...
@section('content')
    ...
    <section id="hero" class="d-flex align-items-center position-relative vh-100"
        ...
        <div class="container position-relative text-white z-index-1 text-center" data-aos="fade-up">
            ...
            <p class="lead mb-0 text-white mx-auto" style="max-width: 800px;">Chất lượng là nền tảng: Luôn đặt chất lượng sản
                phẩm lên hàng đầu, từ quy trình sản xuất đến tiêu chuẩn an toàn thực phẩm quốc tế.</p>
        </div>
    </section>
                            ...
                            <div class="card h-100 border-0 shadow-sm product-card transition-all">
                                <div class="position-relative overflow-hidden rounded-top-4">
                                    <a href="vietnam-green-tea-f-pro108.html">
                                        <img src="upload/product/thumbs/vietnam-green-tea-f1745394268.png"
                                            class="card-img-top w-100 object-fit-cover" alt="Vietnam Green Tea: F"
                                            style="height: 250px;">
                                    </a>
                                </div>
                                <div class="card-body text-center p-4">
                                    <h5 class="card-title mb-3">
                                        <a href="vietnam-green-tea-f-pro108.html"
                                            class="text-dark text-decoration-none fw-semibold product-title">Vietnam Green
                                            Tea: F</a>
                                    </h5>
                            ...
                            <div class="card h-100 border-0 shadow-sm product-card transition-all">
                                <div class="position-relative overflow-hidden rounded-top-4">
                                    <a href="vietnam-green-tea-op-pro107.html">
                                        <img src="upload/product/thumbs/vietnam-green-tea-op1745394225.png"
                                            class="card-img-top w-100 object-fit-cover" alt="Vietnam Green Tea: OP"
                                            style="height: 250px;">
                                    </a>
                                </div>
                                <div class="card-body text-center p-4">
                        ...
                        <div class="col" data-aos="fade-up" data-aos-delay="500">
                            <div class="card h-100 border-0 shadow-sm product-card transition-all">
                                ...
                                <div class="card-body text-center p-4">
                                    ...
                                    <a href="lien-he.html" class="btn btn-success rounded-pill px-4 py-2 w-100">Liên hệ
                                        báo giá</a>
                                </div>
                            </div>
                        </div>
