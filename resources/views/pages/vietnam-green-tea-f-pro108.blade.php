@extends('layouts.app')
@section('title', 'Vietnam Green Tea F Pro108')
@section('content')
        ...
        <div class="container py-4">
            <div class="row g-5">
                        ...
                        <div class="featured-image">
                            <div class="dtpro_outer">
                                <div id="dtpro_big" class="owl-carousel owl-theme">
                                    <div class="item">
                                        <img src="upload/product/vietnam-green-tea-f1745394268.png" alt="Vietnam Green Tea: F" class="img-fluid rounded-3 object-fit-cover w-100" style="max-height: 500px;">
                                    </div>
                                </div>
                                <div id="dtpro_thumbs" class="owl-carousel owl-theme d-none">
                                    <div class="item"><img src="upload/product/vietnam-green-tea-f1745394268.png" alt="Vietnam Green Tea: F"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-7 col-md-6" data-aos="fade-left">
                    <form enctype="multipart/form-data" id="add-to-cart-form" action="https://kimthanhintc.com/cart/108.html" method="post">
                        <input id="idpro" type="hidden" value="108">
                        <input id="urlpro" type="hidden" value="https://kimthanhintc.com/vietnam-green-tea-f-pro108.html">
                        ...
                        <div class="products_details_info bg-white p-4 rounded-4 shadow-sm h-100 border">
                            ...
                            <h1 class="display-6 fw-bold mb-4 text-success" itemprop="name">Vietnam Green Tea: F</h1> 
                            ...
                            <div class="col-md-7 p-5 bg-white" data-aos="fade-left">
                                ...
                                <form action="https://kimthanhintc.com/contact.html" name="frmContact" id="frmContact" method="post">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <textarea name="content" class="form-control bg-light border-0" id="messageInput" placeholder="Lời nhắn" style="height: 120px" required>Tôi quan tâm đến sản phẩm Vietnam Green Tea: F</textarea>
