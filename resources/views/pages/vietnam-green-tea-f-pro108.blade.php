...
<div id="dtpro_thumbs" class="owl-carousel owl-theme">
 <div class="item"><img src="upload/product/vietnam-green-tea-f1745394268.png" alt="Vietnam Green Tea: F"></div>
					...
					<form enctype="multipart/form-data" id="add-to-cart-form" action="https://kimthanhintc.com/cart/108.html" method="post" class="form-inline">
