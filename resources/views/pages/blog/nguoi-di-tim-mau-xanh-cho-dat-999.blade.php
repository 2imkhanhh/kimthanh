@extends('layouts.app')
@section('title', 'Người đi tìm màu xanh cho đất')
@section('content')
<!-- BLOG POST -->
    ...
    <div class="swiper related-posts-swiper pb-4">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="card h-100 border-0 shadow-sm blog-card transition-all">
                    <div class="position-relative overflow-hidden rounded-top-4">
                        <a href="nguoi-di-tim-mau-xanh-cho-dat-259.html">
                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        <h5 class="card-title mb-3 lh-base">
                            <a href="nguoi-di-tim-mau-xanh-cho-dat-259.html" class="text-dark text-decoration-none fw-semibold blog-title">Người đi tìm màu xanh cho đất</a>
                        </h5>
                        <div class="mt-auto d-flex justify-content-between align-items-center pt-3 border-top">
                            <span class="text-muted small"><i class="fa-regular fa-calendar-days me-2"></i>23-04-2025</span>
                            <a href="nguoi-di-tim-mau-xanh-cho-dat-259.html" class="text-success text-decoration-none small fw-semibold text-uppercase letter-spacing-1">Xem chi tiết <i class="fa-solid fa-angle-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="card h-100 border-0 shadow-sm blog-card transition-all">
                    <div class="position-relative overflow-hidden rounded-top-4">
                        <a href="nguoi-di-tim-mau-xanh-cho-dat-262.html">
                            <img src="{{ asset('upload/post/thumbs/nguoi-di-tim-mau-xanh-cho-dat1745404857.jpg') }}" class="card-img-top w-100 object-fit-cover" alt="Người đi tìm màu xanh cho đất" style="height: 250px;">
                        </a>
                    </div>
                    <div class="card-body p-4 d-flex flex-column">
                        <h5 class="card-title mb-3 lh-base">
                            <a href="nguoi-di-tim-mau-xanh-cho-dat-262.html" class="text-dark text-decoration-none fw-semibold blog-title">Người đi tìm màu xanh cho đất</a>
                        </h5>
                        <div class="mt-auto d-flex justify-content-between align-items-center pt-3 border-top">
                            <span class="text-muted small"><i class="fa-regular fa-calendar-days me-2"></i>23-04-2025</span>
                            <a href="nguoi-di-tim-mau-xanh-cho-dat-262.html" class="text-success text-decoration-none small fw-semibold text-uppercase letter-spacing-1">Xem chi tiết <i class="fa-solid fa-angle-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="card h-100 border-0 shadow-sm blog-card transition-all">
                    <div class="position-relative overflow-hidden rounded-top-4">
                        <a href="nhung-loi-ich-co-the-ban-chua-biet-ve-che-xanh-261.html">
                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        <h5 class="card-title mb-3 lh-base">
                            <a href="nhung-loi-ich-co-the-ban-chua-biet-ve-che-xanh-261.html" class="text-dark text-decoration-none fw-semibold blog-title">Những lợi ích có thể bạn chưa biết về chè xanh</a>
                        </h5>
                        <div class="mt-auto d-flex justify-content-between align-items-center pt-3 border-top">
                            <span class="text-muted small"><i class="fa-regular fa-calendar-days me-2"></i>23-04-2025</span>
                            <a href="nhung-loi-ich-co-the-ban-chua-biet-ve-che-xanh-261.html" class="text-success text-decoration-none small fw-semibold text-uppercase letter-spacing-1">Xem chi tiết <i class="fa-solid fa-angle-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="card h-100 border-0 shadow-sm blog-card transition-all">
                    <div class="position-relative overflow-hidden rounded-top-4">
                        <a href="nhung-loi-ich-co-the-ban-chua-biet-ve-che-xanh-264.html">
                            <img src="{{ asset('upload/post/thumbs/nhung-loi-ich-co-the-ban-chua-biet-ve-che-xanh1745404885.jpg') }}" class="card-img-top w-100 object-fit-cover" alt="Những lợi ích có thể bạn chưa biết về chè xanh" style="height: 250px;">
                        </a>
                    </div>
                    <div class="card-body p-4 d-flex flex-column">
                        <h5 class="card-title mb-3 lh-base">
                            <a href="nhung-loi-ich-co-the-ban-chua-biet-ve-che-xanh-264.html" class="text-dark text-decoration-none fw-semibold blog-title">Những lợi ích có thể bạn chưa biết về chè xanh</a>
                        </h5>
                        <div class="mt-auto d-flex justify-content-between align-items-center pt-3 border-top">
                            <span class="text-muted small"><i class="fa-regular fa-calendar-days me-2"></i>23-04-2025</span>
                            <a href="nhung-loi-ich-co-the-ban-chua-biet-ve-che-xanh-264.html" class="text-success text-decoration-none small fw-semibold text-uppercase letter-spacing-1">Xem chi tiết <i class="fa-solid fa-angle-right ms-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
