                            ...
                            <div class="col-md-7 p-5 bg-white" data-aos="fade-left">
                                ...
                                <form action="https://kimthanhintc.com/contact.html" name="frmContact" id="frmContact" method="post">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <textarea name="content" class="form-control bg-light border-0" id="messageInput" placeholder="Lời nhắn" style="height: 120px" required>Tôi quan tâm đến sản phẩm Vietnam Green Tea: BPS</textarea>
