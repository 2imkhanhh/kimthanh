                    ...
                    <div class="card h-100 border-0 shadow-sm blog-card transition-all">
                        <div class="position-relative overflow-hidden rounded-top-4">
                            <a href="blog/nguoi-di-tim-mau-xanh-cho-dat-259.html">
                                <img src="upload/post/thumbs/nguoi-di-tim-mau-xanh-cho-dat1745404857.jpg"
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            <h5 class="card-title mb-3 lh-base">
                                <a href="blog/nguoi-di-tim-mau-xanh-cho-dat-259.html"
                                    class="text-dark text-decoration-none fw-semibold blog-title">Người đi tìm màu xanh cho
                                    đất</a>
                            </h5>
                            <div class="mt-auto d-flex justify-content-between align-items-center pt-3 border-top">
                                <span class="text-muted small"><i
                                        class="fa-regular fa-calendar-days me-2"></i>23-04-2025</span>
                                <a href="blog/nguoi-di-tim-mau-xanh-cho-dat-259.html"
                                    class="text-success text-decoration-none small fw-semibold text-uppercase letter-spacing-1">Xem
                                    chi tiết <i class="fa-solid fa-angle-right ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card h-100 border-0 shadow-sm blog-card transition-all">
                        <div class="position-relative overflow-hidden rounded-top-4">
                            <a href="blog/phat-trien-che-ben-vung-phai-gan-voi-nong-nghiep-sach-260.html">
                                <img src="upload/post/thumbs/phat-trien-che-ben-vung-phai-gan-voi-nong-nghiep-sach1745404872.jpg"
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            <h5 class="card-title mb-3 lh-base">
                                <a href="blog/phat-trien-che-ben-vung-phai-gan-voi-nong-nghiep-sach-260.html"
                                    class="text-dark text-decoration-none fw-semibold blog-title">Phát triển chè bền vững
                                    phải gắn với nông nghiệp sạch</a>
                            </h5>
                            <div class="mt-auto d-flex justify-content-between align-items-center pt-3 border-top">
                                <span class="text-muted small"><i
                                        class="fa-regular fa-calendar-days me-2"></i>23-04-2025</span>
                ...
                <div class="col" data-aos="fade-up" data-aos-delay="300">
                    <div class="card h-100 border-0 shadow-sm blog-card transition-all">
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            <h5 class="card-title mb-3 lh-base">
                                <a href="blog/nhung-loi-ich-co-the-ban-chua-biet-ve-che-xanh-261.html"
                                    class="text-dark text-decoration-none fw-semibold blog-title">Những lợi ích có thể bạn
                                    chưa biết về chè xanh</a>
                            </h5>
                            <div class="mt-auto d-flex justify-content-between align-items-center pt-3 border-top">
                                <span class="text-muted small"><i
                                        class="fa-regular fa-calendar-days me-2"></i>23-04-2025</span>
