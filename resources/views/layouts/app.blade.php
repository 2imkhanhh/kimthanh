        ...
        <nav class="navbar navbar-expand-lg navbar-light py-3">
            <div class="container">
                ...
                <div class="d-none d-lg-flex align-items-center">
                    <div class="dropdown">
                        <button class="btn btn-outline-secondary dropdown-toggle rounded-pill px-3" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            VN <img src="images/vietnam_flag.jpg" alt="VN" width="20" class="ms-1">
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow">
                            <li><a class="dropdown-item d-flex align-items-center justify-content-between" href="en/index.html">EN <img src="images/flag_en.jpg" alt="EN" width="20"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-4 col-md-6">
                    <a href="/" class="d-inline-block mb-3">
                        <img src="upload/banner/logo1698075966.png" alt="Logo Kim Thành" height="60" class="bg-white p-2 rounded shadow-sm">
                    </a>
                    <h5 class="text-white mb-3">CÔNG TY TNHH ĐẦU TƯ THƯƠNG MẠI KIM THÀNH</h5>
                    <p class="text-white-50 small mb-2"><i class="fa-solid fa-location-dot me-2"></i> Xóm Chanh, Xã Sơn Hùng, Huyện Thanh Sơn, tỉnh Phú Thọ, Việt Nam.</p>
                    <p class="text-white-50 small mb-2"><i class="fa-solid fa-envelope me-2"></i> <a href="mailto:kimthanhinvestmenttradingltd@gmail.com" class="text-white-50 text-decoration-none">kimthanhinvestmenttradingltd@gmail.com</a></p>
                    <p class="text-white-50 small mb-2"><i class="fa-solid fa-phone me-2"></i> 0986843666 - 0965748456</p>
                    <p class="text-white-50 small"><i class="fa-solid fa-building me-2"></i> MST 2601039326 (Sở KH & ĐT Tỉnh Phú Thọ cấp 03/02/2020)</p>
                </div>
                <div class="col-lg-4 col-md-6">
                    <h5 class="text-white mb-4">Liên Kết Nhanh</h5>
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="gioi-thieu.html" class="text-white-50 text-decoration-none hover-white"><i class="fa-solid fa-chevron-right me-2 small"></i> Giới thiệu</a></li>
                        <li class="mb-2"><a href="san-pham.html" class="text-white-50 text-decoration-none hover-white"><i class="fa-solid fa-chevron-right me-2 small"></i> Sản phẩm</a></li>
                        <li class="mb-2"><a href="blog.html" class="text-white-50 text-decoration-none hover-white"><i class="fa-solid fa-chevron-right me-2 small"></i> Tin tức</a></li>
                        <li class="mb-2"><a href="lien-he.html" class="text-white-50 text-decoration-none hover-white"><i class="fa-solid fa-chevron-right me-2 small"></i> Liên hệ</a></li>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-12">
                    <h5 class="text-white mb-4">Đăng Ký Nhận Tin</h5>
                    <p class="text-white-50 small mb-3">Đăng ký email để nhận những thông tin mới nhất về các sản phẩm trà của chúng tôi.</p>
                    <form class="d-flex shadow-sm">
                        <input type="email" class="form-control border-0 rounded-start-pill px-4" placeholder="Email của bạn..." required>
                        <button class="btn btn-success rounded-end-pill px-4" type="submit">Gửi</button>
                    </form>
                </div>
            </div>
            ...
            <div class="row text-center text-md-start">
                ...
                <div class="col-md-6 text-md-end mt-2 mt-md-0">
                    <div class="social-links">
                        <a href="#" class="text-white-50 me-3 hover-white"><i class="fa-brands fa-youtube fs-5"></i></a>
                        <a href="#" class="text-white-50 me-3 hover-white"><i class="fa-brands fa-facebook fs-5"></i></a>
